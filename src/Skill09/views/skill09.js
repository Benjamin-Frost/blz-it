    ...
    <div>
      ...
      <Container>
        <section className="py-4">
          ...
          <p className="lead text-justify">
            Du beherrschst mindestens eine Programmiersprache, am besten C#,
            programmierst Mobile Apps, hast Kenntnisse in UML und Datenbanken
            (SQL) und verstehst englischsprachige Aufgabenstellungen.
          </p>
        </section>
        <section className="py-4">
          <h3 className="h1 text-center pb-3">
        ...
        <section className="py-4">
          ...
          <p className="lead text-justify">
            Das dreiköpfige Deutsche Nationalteam im Skill 09, bestimmt durch
        ...
        <section className="py-4">
          ...
          <p className="lead text-justify">
            ...
            vertreten, darunter auch im Skill 09 (
            <a
